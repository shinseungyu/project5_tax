  ...
  return (
    <main style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px', fontFamily: 'sans-serif', color: '#333', lineHeight: '1.8' }}>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p>
          본 약관은 <strong>newsioo.com</strong> (이하 &quot;사이트&quot;)이 제공하는 &quot;관세계산기&quot; 서비스(이하 &quot;서비스&quot;)의
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <ul style={{ paddingLeft: '20px', marginTop: '8px' }}>
          <li>해외 직구 관세 및 부가세 자동 계산 서비스</li>
          <li>합산과세 계산기</li>
          <li>실시간 환율 정보 제공</li>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p>
          본 사이트에서 제공하는 관세 및 부가세 계산 결과는 <strong>참고용</strong>이며, 법적 효력이 없습니다.
          실제 관세 및 세액은 관세청 기준에 따라 달라질 수 있으며, 정확한 세액은 관세청(customs.go.kr)에서 확인하시기 바랍니다.
          계산 결과에 따른 실제 세금 납부 결과에 대해 사이트는 책임을 지지 않습니다.
        </p>
      </section>
